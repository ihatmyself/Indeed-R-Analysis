...
us_cities <- data.frame(
  city = c("Austin", "Chicago", "Houston", "Los Angeles", "New York"),
  lon = c(-97.7431, -87.6298, -95.3698, -118.2437, -74.006),
  lat = c(30.2672, 41.8781, 29.7604, 34.0522, 40.7128)
)

# Create a map of US cities
ggplot() +
  geom_polygon(data = us_map, aes(x = long, y = lat, group = group), fill = "white", color = "black") +
  geom_point(data = us_cities, aes(x = lon, y = lat), size = 3, color = "red") +
