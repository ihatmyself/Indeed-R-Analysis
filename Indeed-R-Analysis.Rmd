...
ggplot(combined_data, aes(x = city, y = Average_Salary/1000)) +
  ...
  labs(title = "Boxplot of Salary by City", x = "City", y = "Mean Average Salary (thousands)")+ 
...
ggplot(combined_data, aes(x = Job_title, y = Average_Salary/1000)) +
  ...
  labs(title = "Boxplot of Salary by Job Title", x = "Title", y = "Mean Average Salary (thousands)")+ 
  coord_cartesian(ylim = c(0, 300))+ 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
